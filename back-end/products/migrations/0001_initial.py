# Generated by Django 4.2.8 on 2024-05-18 14:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sale_co', models.CharField(max_length=100)),
                ('dcls_strt_day', models.CharField(max_length=10)),
                ('dcls_end_day', models.CharField(blank=True, max_length=10, null=True)),
                ('fin_co_subm_day', models.CharField(max_length=20)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pension', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='options', to='products.pensionproduct')),
            ],
            options={
